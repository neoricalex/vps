...
/**
 * Class TVA_Topic
 * Defines a topic property for a course
 *
 * @property string color
 */
class TVA_Topic extends TVA_Options_List {

	const COURSE_TERM_NAME = 'tva_topic';

	/**
	 * Defines which wp_options should be queried for Topics
	 *
	 * @return string
	 */
	static public function get_option_name() {

		return 'tva_filter_topics';
	}

	/**
	 * @return array[]|TVA_Topic[]
	 */
