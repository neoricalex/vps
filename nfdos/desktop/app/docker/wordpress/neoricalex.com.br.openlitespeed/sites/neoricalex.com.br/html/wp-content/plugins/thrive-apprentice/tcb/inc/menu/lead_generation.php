		...
		<div class="connection-controls" data-connection="api">
			...
			<div class="control-grid">
				<div class="label">
					...
					<span class="click" data-type="help" data-url="https://api.intercom.io/articles/4425882" data-link="https://help.thrivethemes.com/en/articles/4425882-how-to-add-a-custom-field-to-the-lead-generation-element" data-fn="openInstructionsLightbox"><?php tcb_icon( 'help-instructions' ); ?></span>
				</div>
				<div class="full">
